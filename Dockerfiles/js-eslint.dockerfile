# Also in src/Command/JsEslint.php
ARG COMMAND='/usr/local/lib/node_modules/eslint/bin/eslint.js --config /config/Eslint.js --ignore-path /config/Eslint-Ignore --color --ext .js $FOLDER'
ARG FILE='/js-eslint'
ARG PACKAGE='eslint@^8.0.0'
